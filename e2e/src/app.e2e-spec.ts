...
describe('workspace-project App', () => {
  ...
  it('should display message saying Ristorante KungFucius', () => {
    page.navigateTo('/');
    expect(page.getParagraphText('app-root h1')).toEqual('Ristorante KungFucius');
  });

  it('should go to about us page by clicking on the link', () => {
    page.navigateTo('/');
